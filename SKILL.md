...
3. Use the generated Markdown for a human-facing review. Use JSON when another tool or agent will consume the data.
4. Treat the extracted data as marketplace claims and user-review signals, not verified lab measurements.
5. Mention data limits when relevant: Pinduoduo can translate text in Chrome, reorder visible reviews, or hide deeper comments behind dynamic loading.
